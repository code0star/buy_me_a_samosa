...
export default function Home() {
  return (
    <div className="text-white block sm:flex px-9 items-center justify-evenly h-[800px] sm:h-[81.5vh]  ">
        ...
        <div className="my-0 flex justify-around " >
          <div className="flex-col justify-center items-center ">
            ...
            <div className="h-[120px]">
              <img src="/services.gif" alt="" className="  sm:right-[28vw]  sm:w-[18vw]  sm:h-[40vh]" />
            </div>
          ...
          <div className="flex-col justify-center items-center">
            ...
            <div>
              <img src="/portfolio.gif" alt="" className="  sm:right-[10vw]   sm:w-[18vw] sm:h-[40vh]" />
            </div>
